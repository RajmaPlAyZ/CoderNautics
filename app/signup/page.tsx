  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] px-4">
      <form onSubmit={handleSubmit} className="bg-white p-8 rounded-lg border-4 border-black shadow-[0_6px_0_#222] w-full max-w-sm space-y-6 font-comic">
        ...
        <button type="submit" className="w-full bg-green-300 text-green-800 font-extrabold py-3 rounded-md border-4 border-black shadow-[0_4px_0_#222] hover:bg-green-400 transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
          disabled={loading}>
